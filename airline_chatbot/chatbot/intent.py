...
INTENT_SYSTEM = (
    ...
    "check_in_faq, flight_status, refund_request, baggage_track, disruption, "
    "general_faq, greeting. "
...
INTENT_ROUTES = {
    ...
    "refund_request": "User asks how much refund they will get for a PNR",
    "baggage_track": "User wants to track their baggage",
    "disruption": "User says their flight was cancelled or severely delayed",
