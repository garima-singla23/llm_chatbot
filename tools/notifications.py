...
def send_email_confirmation(email:str, name:str, pnr:str,
                             flight:dict, seat:str,
                             boarding_time:str, amount:int)->bool:
      ...
      <body style="margin:0;padding:0;background:#0b0f13;font-family:Arial,sans-serif;color:#e6eef6;">
        <div style="max-width:640px;margin:0 auto;padding:24px;">
          ...
          <div style="background:#111826;border:1px solid rgba(255,255,255,.06);border-top:none;border-radius:0 0 16px 16px;padding:24px;">
            ...
            <p style="margin:0 0 18px;color:#9fb0c8;">Keep this confirmation for check-in and boarding.</p>
            ...
            <p style="margin:18px 0 0;font-size:12px;color:#7f93ad;">AirAssist — AI Airline Concierge · This is an automated confirmation</p>
          </div>
        </div>
      </body>
    </html>
...
def send_sms_confirmation(phone:str, name:str, pnr:str,
                           flight:dict, seat:str, boarding_time:str)->bool:
...
def send_booking_confirmation(email:str, phone:str, name:str,
                               pnr:str, flight:dict, seat:str,
                               boarding_time:str, amount:int):
  """Send both email and SMS confirmation. Both run independently."""
...
def send_delay_alert(phone:str, email:str, name:str,
                     pnr:str, flight_no:str, delay_minutes:int):
